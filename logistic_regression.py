...
def do_experiments(start, end, step_num):
    ...
    for i, distance in enumerate(shift_distances, 1):
        ...
        # Append parameters for plotting later
        ...
        sample_data[distance] = (X, y, model, beta0, beta1, beta2, slope, intercept, loss)

        # Implement: Plot the dataset
        plt.subplot(n_rows, n_cols, i)
        plt.scatter(X[:, 0], X[:, 1], c=y, cmap='coolwarm', edgecolor='k', s=50)

        # Define x_min and x_max before plotting the decision boundary
